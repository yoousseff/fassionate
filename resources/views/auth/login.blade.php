...
<div class="">
      <div class="flex  ">
        <div class="order-2 hidden md:block h-screen min-h-full">
          <img src="{{asset('assets/forms/loginandnew.webp')}}" class="w-full h-full object-cover" alt="login-image" />
        </div>

        <form class="max-w-xl w-full p-6 mx-auto" method="POST" action="{{ route('login') }}">
            @csrf
          <div class="mb-12">
            <h3 class="text-gray-800 text-4xl font-extrabold">Log in</h3>
            <p class="text-gray-800 text-sm mt-6">Don't have an account <a href="{{Route('register')}}" class="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Register here</a></p>
          </div>
          ...
          <div>
            ...
            <div  class="flex flex-col">
              ...
              <div class="relative flex items-center">
                <input name="email" id="email" type="text" required class="w-full text-sm text-gray-800 border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter email" />
